...
public class BannerController {
    ...
    @Operation(summary = "활성 배너/공지 목록 — 기간 내, 정렬 순")
    @GetMapping
    public List<BannerView> list(@RequestParam(defaultValue = "AD") BannerKind kind) {
        return bannerService.activeBanners(kind);
    }
}
